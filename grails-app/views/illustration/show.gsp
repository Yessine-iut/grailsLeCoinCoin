...
<html>
    ...
    <body>
        ...
        <div id="show-illustration" class="content scaffold-show" role="main">
            ...
            <img width="250px" src="${grailsApplication.config.illustrations.baseUrl+illustration.filename}" />
            <g:link controller="annonce" action="show" id="${this.illustration.annonce.id}">Lien vers l'annonce</g:link>
