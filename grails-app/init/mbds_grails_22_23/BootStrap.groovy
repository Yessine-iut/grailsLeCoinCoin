...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def moderatorUserInstance = new User(username: "mathildelecoincoin",password: "lecoincoin").save()
        def moderatorRole = new Role(authority: "ROLE_MODERATOR").save()
        UserRole.create(moderatorUserInstance, moderatorRole, true)

        def clientUserInstance = new User(username: "anthony",password: "client").save()
